...
file1_path = 'C:\\Users\\mateo\\Downloads\\sport2.csv'
file2_path = 'C:\\Users\\mateo\\Downloads\\piscinas2.csv'
...
print('Rows present in both files have been removed from the first file.')
